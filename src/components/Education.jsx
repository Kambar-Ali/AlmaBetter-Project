...
function Education() {
  ...
  return (
    <div style={{ backgroundColor: 'maroon' }}>
      <Row className="justify-content-center mt-2" style={{ backgroundColor: 'maroon', color: 'Maroon' }}>
        ...
        <Modal show={show} onHide={handleClose} centered scrollable={true} backdrop="static">
          ...
          <Modal.Body>
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              ...
              <button type="submit" className="rounded edit px-2" style={{ backgroundColor: 'white' }}>
                <span style={{ color: 'maroon', fontWeight: 'bold' }}>Save Changes</span>
              </button>
