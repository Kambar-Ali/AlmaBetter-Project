...
function Profile() {
    ...
    return (
        <>
            <Row className="justify-content-center" style={{ backgroundColor: 'Maroon', color: 'white', padding: '20px' }}>
            ...
            <Row className="justify-content-center mt-2" style={{ backgroundColor: 'Maroon', color: 'white', padding: '20px' }}>
                <Col md={4} sm={6}>
                    <Col>
                        <h4>{profile.name}</h4>
                    </Col>
            ...
            <Modal show={show} onHide={handleClose} centered backdrop="static">
                ...
                <Modal.Body style={{ backgroundColor: 'Maroon', color: 'white' }}>
                    <Form>
                ...
                <Modal.Footer style={{ backgroundColor: 'Maroon', color: 'white' }}>
                    <button type="submit" className="rounded edit px-2" onClick={handleClose} style={{ color: 'maroon', backgroundColor: 'white', fontWeight: 'bold' }}>
                        Save Changes
                    </button>
                </Modal.Footer>
            </Modal>
