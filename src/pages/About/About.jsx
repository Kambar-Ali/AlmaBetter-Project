...
const About = () => {
    // Replace these links with your own social media profile links
    const socialLinks = {
        whatsapp: 'https://wa.me/+919125241370',
        linkedin: 'https://www.linkedin.com/in/kambar-ali/',
        facebook: 'https://www.facebook.com/royalnawabprince.com',
        email: 'mailto: alikambar9125@gmail.com'
    };
    ...
    return (
        <div className="about-us-container">
            ...
            <Grid container className="share-icons" justifyContent="center">
                <Grid item>
                    <IconButton color="primary" component="a" href={socialLinks.whatsapp} target="_blank">
                        <WhatsAppIcon />
                    </IconButton>
                </Grid>
                <Grid item>
                    <IconButton color="primary" component="a" href={socialLinks.linkedin} target="_blank">
                        <LinkedInIcon />
                    </IconButton>
                </Grid>
                <Grid item>
                    <IconButton color="primary" component="a" href={socialLinks.facebook} target="_blank">
                        <FacebookIcon />
                    </IconButton>
                </Grid>
                <Grid item>
                    <IconButton color="primary" component="a" href={socialLinks.email}>
                        <EmailIcon />
                    </IconButton>
                </Grid>
            </Grid>
